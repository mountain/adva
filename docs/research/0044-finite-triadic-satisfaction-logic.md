...
The Legendre three-cusp closure from note 0042 and its executable coherence
prism from note 0043 supply the bounded carrier.  Note 0043 deliberately left
a read-only logical quotation port; this note implements its first finite
closure fragment without allowing logic to control the crossing calculus.
