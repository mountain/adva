...
theorem adva152e6 (x : Int) : ((((x + x) + ((2 : Int) * x)) + ((x + x) + ((2 : Int) * x))) + (((x + x) + ((2 : Int) * x)) + ((x + x) + (x + x)))) = ((((x + x) + (x + x)) + ((x + x) + ((2 : Int) * x))) + (((x + x) + ((2 : Int) * x)) + ((x + x) + (x + x)))) := (congrArg (fun (z : Int) => (z + (((x + x) + ((2 : Int) * x)) + ((x + x) + (x + x))))) ((congrArg (fun (z : Int) => (z + ((x + x) + ((2 : Int) * x)))) ((congrArg (fun (z : Int) => ((x + x) + z)) ((Int.two_mul x)))))))
#print axioms adva152e6
theorem adva152e7 (x : Int) : ((((x + x) + (x + x)) + ((x + x) + ((2 : Int) * x))) + (((x + x) + ((2 : Int) * x)) + ((x + x) + (x + x)))) = ((((x + x) + (x + x)) + ((x + x) + (x + x))) + (((x + x) + ((2 : Int) * x)) + ((x + x) + (x + x)))) := (congrArg (fun (z : Int) => (z + (((x + x) + ((2 : Int) * x)) + ((x + x) + (x + x))))) ((congrArg (fun (z : Int) => (((x + x) + (x + x)) + z)) ((congrArg (fun (z : Int) => ((x + x) + z)) ((Int.two_mul x)))))))
#print axioms adva152e7
theorem adva152e8 (x : Int) : ((((x + x) + (x + x)) + ((x + x) + (x + x))) + (((x + x) + ((2 : Int) * x)) + ((x + x) + (x + x)))) = ((((x + x) + (x + x)) + ((x + x) + (x + x))) + (((x + x) + (x + x)) + ((x + x) + (x + x)))) := (congrArg (fun (z : Int) => ((((x + x) + (x + x)) + ((x + x) + (x + x))) + z)) ((congrArg (fun (z : Int) => (z + ((x + x) + (x + x)))) ((congrArg (fun (z : Int) => ((x + x) + z)) ((Int.two_mul x)))))))
