# A common frame received by the knowledge interface

The same eight-file iota frame package has been received by adva and
adva-machine. This record is the **knowledge** reception and its actual
post-arrival check. The [frame specification](../../received/iota-frame-knowledge-2026-09-17-v1/materials/frame.md)
...
2,028,019 counted host units, 6.773 s wall,
6.574 s CPU and 96476 KiB peak RSS.
...
on replay. The [native receipt](../../received/iota-frame-knowledge-2026-09-17-v1/receipt.json) still records
...
The four native calls took 0.173 s wall and read
1,067,227 aggregate bytes. There were no new native
...
[here](../../../governance/publication/records/iota-frame-knowledge-2026-09-17-v1.json);
receiver output review is [separate](../../../governance/publication/records/iota-frame-knowledge-2026-09-17-v1-outputs.json).
...
packets, and a fresh output directory:
    ...
    python knowledge/received/iota-frame-knowledge-2026-09-17-v1/materials/check.py \
      --materials knowledge/received/iota-frame-knowledge-2026-09-17-v1/materials \
      --iota-materials knowledge/received/iota-process-knowledge-2026-09-17-v1/materials \
      --expect-package 3a05875e0134684978c81ef3bdb2d6a2a4455403fa5d9901856df6e28f1337a7 \
      --stage knowledge-after-reception --output /fresh/external/frame-check
