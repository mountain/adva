# Iota received by the knowledge interface

The same eight-file iota package was received separately by adva and
adva-machine on 2026-09-17. This record is the **knowledge** reception and its
post-arrival interpretation check. The [received presentation](../../received/iota-process-knowledge-2026-09-17-v1/materials/iota.md)
...
[here](sender-acknowledgment.json). The [native receipt](../../received/iota-process-knowledge-2026-09-17-v1/receipt.json)
...
- Receiving contract: [contract.json](contract.json), BLAKE3
  `145026407de138cdd2affd4ea54dd7a1a8dd3fa78e6f0ea3499609baa124774e`.
- Publication admission: [exact eight-file review](../../../governance/publication/records/iota-process-knowledge-2026-09-17-v1.json).
- Complete execution inventories: [evidence-manifest.json](evidence-manifest.json).
- Other receiver: [adva-machine reception](https://github.com/mountain/adva-machine/tree/main/knowledge/exchanges/iota-process-machine-2026-09-17-v1).

This transport used four native calls, 1,173,523
aggregate bytes read and 0.158 wall seconds.
The subsequent comparison used 3,655 counted host units,
1.187 wall seconds and
1.005 aggregate CPU seconds.
...
With the exact pinned machine executable and its external Python dependencies:
    ...
    python knowledge/received/iota-process-knowledge-2026-09-17-v1/materials/check.py \
      --materials knowledge/received/iota-process-knowledge-2026-09-17-v1/materials \
      --expect-package 58aad08d14563201e8adb632db0a61d23016851878f103ba002da9aebba7e772 \
      --machine /path/to/pinned/adva-machine \
      --stage knowledge-after-reception --output /fresh/external/output
